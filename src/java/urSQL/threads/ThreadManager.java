...
public class ThreadManager {
    ...
    private String _Dir = logHandler.getInstance().getRootPath()+ "urSQL/";////////////////////////////////PATH
    ...
    public String sendQuery(String pQuery) throws InterruptedException, ExecutionException, Exception {
        ...
        _Pool.shutdown();
        System.gc();
        System.out.println(_DATA.getState());
        System.out.println(_DATA.getError());
    ...
    public void HOtFIx() throws Exception{
        hBplusTree.ReOpen(_Dir + "DataBases/" + "System_Catalog/" + "Sys_Tables" + ".tree",_Dir + "DataBases/" + "System_Catalog/" + "Sys_Tables" + ".table").Shutdown();
        hBplusTree.ReOpen(_Dir + "DataBases/" + "System_Catalog/" + "Sys_Schemas" + ".tree",_Dir + "DataBases/" + "System_Catalog/" + "Sys_Schemas" + ".table").Shutdown();
        hBplusTree.ReOpen(_Dir + "DataBases/" + "System_Catalog/" + "Sys_Columns" + ".tree",_Dir + "DataBases/" + "System_Catalog/" + "Sys_Columns" + ".table").Shutdown();
    }*/
}
